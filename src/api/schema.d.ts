...
export interface paths {
    ...
    "/foundations": {
        ...
        /** List foundation profiles */
        get: operations["FoundationsController_findAll"];
        put?: never;
        /** Create a foundation profile */
        post: operations["FoundationsController_create"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/foundations/{id}": {
        ...
        /** Get a foundation profile */
        get: operations["FoundationsController_findOne"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
        /** Update a foundation profile */
        patch: operations["FoundationsController_update"];
        trace?: never;
    };
    "/auth/login": {
        parameters: {
    ...
    "/historical-records/enrollments": {
        ...
        post: operations["HistoricalRecordsController_createEnrollment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/historical-records/reminders": {
        ...
        get?: never;
        put?: never;
        /** Create a historical reminder */
        post: operations["HistoricalRecordsController_createReminder"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/historical-records/medical-appointments": {
        ...
        get?: never;
        put?: never;
        /** Create a historical medical appointment */
        post: operations["HistoricalRecordsController_createMedicalAppointment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/historical-records/psychooncology-appointments": {
        ...
        get?: never;
        put?: never;
        /** Create a historical psycho-oncology appointment */
        post: operations["HistoricalRecordsController_createPsychooncologyAppointment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        FollowUpTimelineEventDto: {
            ...
            historicalLoadedByEmail: string | null;
            /** @enum {string} */
            status: "SCHEDULED" | "COMPLETED" | "CANCELLED" | "NO_ANSWER";
            /** Format: uuid */
            followUpId: string;
        ...
        CreateHistoricalPsychooncologyAppointmentDto: {
            /** Format: uuid */
            patientId: string;
            /** Format: uuid */
            volunteerId?: string;
...
export interface operations {
    ...
    FoundationsController_findAll: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["FoundationResponseDto"][];
                };
            };
            /** @description JWT missing, invalid, or expired */
            401: {
    ...
    FoundationsController_create: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateFoundationDto"];
            };
        };
        responses: {
            201: {
    ...
    FoundationsController_findOne: {
        ...
        responses: {
            ...
            /** @description Foundation profile not found */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    FoundationsController_update: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateFoundationDto"];
            };
        };
        responses: {
            200: {
    ...
    HistoricalRecordsController_createEnrollment: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateHistoricalEnrollmentDto"];
            };
        };
        responses: {
            201: {
    ...
    HistoricalRecordsController_createFollowUp: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateHistoricalFollowUpDto"];
            };
        };
        responses: {
            201: {
            ...
            /** @description Historical follow-up is invalid */
            400: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    HistoricalRecordsController_createReminder: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateHistoricalReminderDto"];
            };
        };
        responses: {
            201: {
            ...
            /** @description Historical reminder is invalid */
            400: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    HistoricalRecordsController_createMedicalAppointment: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateHistoricalMedicalAppointmentDto"];
            };
        };
        responses: {
            201: {
            ...
            /** @description Historical appointment is invalid */
            400: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    HistoricalRecordsController_createPsychooncologyAppointment: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateHistoricalPsychooncologyAppointmentDto"];
            };
        };
        responses: {
            201: {
